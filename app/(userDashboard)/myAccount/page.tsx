...
const myAccountTiles = [
    {
      title: "Total Orders",
      icon: <div className="p-1 items-center bg-amber-500 rounded-sm"><TbBuildingStore className="text-white"/></div>,
      price: "1,600"
    },
    {
      title: "Total Payments",
      icon: <div className="p-1 items-center bg-green-500 rounded-sm"><FaInstagram className="text-white"/></div>,
      price: "756,000"
    }
  ];
  ...
  return (
    <div className="space-y-5 p-5">
      ...
      {isLoading ? (
        ...
        <OrderTable tableData={allOrders} />
